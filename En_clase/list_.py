#sort sirve para ordenar listas, pero no es un algoritmo de ordenamiento eficiente
...
class List(list):
    ...
    def search(self, search_value: Any):
        #tener en cuenta que la lista debe estar ordenada para que funcione el algoritmo de busqueda binaria
        start = 0
        end = len(self) -1
        middle = (start + end) // 2
